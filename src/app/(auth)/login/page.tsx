...
function getRedirectUrl(role: string, callbackUrl: string | null): string {
  // If there's a specific callback URL that's not a default dashboard, use it
  if (callbackUrl && !callbackUrl.includes("/dashboard") && callbackUrl !== "/") {
    return callbackUrl
  }
