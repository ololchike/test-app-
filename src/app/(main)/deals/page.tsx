  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
      ...
      {lastMinuteDeals.length > 0 && (
        <SectionError name="Last Minute Deals">
      ...
      {earlyBirdDeals.length > 0 && (
        <SectionError name="Early Bird Deals">
